defmodule NearApi.RPC.Network do
  @moduledoc """
  ...
  """
  @spec status() :: {:ok, body :: map} | NearApi.RPC.Errors.t()
  ...
  and the current set of validators.
  """
  @spec network_info() :: {:ok, body :: map} | NearApi.RPC.Errors.t()
  ...
  """
  @spec validators(block_id :: any) :: {:ok, body :: map} | NearApi.RPC.Errors.t()
